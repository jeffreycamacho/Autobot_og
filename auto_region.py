...
def auto_reply_to_slack_thread(notification_images, reply_button_image, reply, delay=0.001, mouse_speed=0.001):
    ...
    reply_button_region = (1250, 0, 1310, 735)
    message_area_x = 2100  # Updated x coordinate
    message_area_y = 370  # Updated y coordinate
...
auto_reply_to_slack_thread(notification_images_paths, reply_button_image_path, reply_text, mouse_speed=0.001)